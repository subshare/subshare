...
public class OldEncryptedDataFile {
	...
	public OldEncryptedDataFile(final byte[] in) throws IOException {
		this(new ByteArrayInputStream(assertNotNull("in", in)));
	}

	public OldEncryptedDataFile(final InputStream in) throws IOException {
		assertNotNull("in", in);
		read(in);
	}

	public OldEncryptedDataFile() {
