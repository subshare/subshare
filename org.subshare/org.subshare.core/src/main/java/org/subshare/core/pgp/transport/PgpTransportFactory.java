...
/**
 * Factory creating instances of classes implementing {@link PgpTransport}.
 * <p>
...
public interface PgpTransportFactory {
	...
	/**
	 * Create a {@link PgpTransport} instance.
	 * @param url the remote-root. Must not be <code>null</code>.
	 * @return a new {@link PgpTransport} instance. Never <code>null</code>.
	 */
